...
class HomeScreen extends ConsumerWidget {
  ...
  Widget _buildNoteList(
      BuildContext context, WidgetRef ref, List notes, String? currentUserId) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          onTap: () => context.push(AppRoutes.noteDetailScreen, extra: note),
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Visibility(
                  ...
                  child: InkWell(
                    onTap: () async {
                      await noteViewModel.deleteNoteById(note.id);
                    },
                    child: Icon(
                      Icons.delete,
                      color: whiteColor,
  ...
  Widget _buildErrorState(
      BuildContext context, NoteViewModel noteViewModel, Object error) {
    return Center(
      child: Column(
          ...
          child: Padding(
            ...
            child: notesState.when(
              data: (notes) => notes.isEmpty
                  ...
                  : _buildNoteList(context, ref, notes, currentUserId),
              loading: () => const Center(
                child: CircularProgressIndicator(),
              ),
              error: (error, stackTrace) =>
                  _buildErrorState(context, noteViewModel, error),
            ),
          ),
        ),
      ),
